...
@Component({
  tag: 'trss-you-belong',
  styleUrl: 'trss-you-belong.scss',
  scoped: false,
})
export class TrssYouBelong {
   ...
   */
  @Prop() header: string = 'You Belong Here';
  ...
  private getAppearance(): string {
    return 'trss-you-belong trss-you-belong--' + this.appearance;
  }
  ...
  render() {
    ...
    return (
        <div class={this.appearance ? this.getAppearance() : 'trss-you-belong trss-you-belong--blue'} aria-hidden={sites.includes(here) ? 'false' : 'true' } role="complementary">
          <div class="trss-row__inner trss-narrow">
            <h3 slot="header">{this.header}</h3>
